...
function mouseover()
{
if (this.getAttribute("button-text-2")){
...
var buttonText2 = payButtons.getAttribute("button-text-2");
...
if ( buttonAmount == "" || amountType == "" || toAddress == "") {

alert("Something is wrong with your paybutton setup\n\nPlease ensure you have the following minimum button requirements set\n\n1. amount\n2. amount-type\n3. address");
...
amountMessage = (buttonAmount + " " + amountType + " = " + bchAmount * 100000000 + " Satoshi");
}

else if (amountType == "SATOSHI") {
bchAmount = buttonAmount / 100000000;
bchAmount = bchAmount.toFixed(8);
amountMessage = (buttonAmount + " " + amountType + " = " + bchAmount + " BCH");
}
